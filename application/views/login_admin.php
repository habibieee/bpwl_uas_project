...
<body class="img js-fullheight" style="background-image: url(<?php echo base_url(); ?>/assets/images/invenbg.jpg);">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        ...
                        <form action="Welcome/aksi_login" class="signin-form" method="POST">
